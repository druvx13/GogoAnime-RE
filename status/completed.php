...
$stmt = $conn->prepare("SELECT id, title, image_url, status FROM anime WHERE status = 'Completed' ORDER BY created_at DESC LIMIT :limit OFFSET :offset");
$stmt->bindValue(':limit', $limit, PDO::PARAM_INT);
$stmt->bindValue(':offset', $offset, PDO::PARAM_INT);
$stmt->execute();
$completedList = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en-US">
...
<head>
        ...
        <meta name="description" content="List completed Anime at <?=$website_name?>">
        <meta name="keywords" content="List completed Anime, Completed Anime">
        <meta itemprop="image" content="<?=$base_url?>/assets/img/logo.png" />

        <meta property="og:site_name" content="<?=$website_name?>" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="List completed Anime at <?=$website_name?>" />
        <meta property="og:description" content="List completed Anime at <?=$website_name?>">
        ...
        <meta property="twitter:title" content="List completed Anime at <?=$website_name?>" />
        <meta property="twitter:description" content="List completed Anime at <?=$website_name?>" />

        <link rel="canonical" href="<?=$base_url?><?php echo $_SERVER['REQUEST_URI'] ?>" />
        <link rel="alternate" hreflang="en-us" href="<?=$base_url?><?php echo $_SERVER['REQUEST_URI'] ?>" />

        <link rel="stylesheet" type="text/css" href="<?=$base_url?>/assets/css/style.css?v=6.9" />
                        ...
                        <div id="wrapper_bg">
                                ...
                                <section class="content">
                                        ...
                                        <section class="content_right">
                                                ...
                                                <?php require('../app/views/partials/sub-category.html'); ?>
                                        </section>
                                </section>
                                <div class="clr"></div>
                                <footer>
